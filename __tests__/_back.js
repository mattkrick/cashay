export const backPaginationWords = {
  first: 'count',
  last: 'count'
};
...
export const back3Query = `query {
  recentPosts(count:3, before: "2014-05-27T00:00:00.000Z") {
    _id,
    cursor,
    title
  }
...
export const back2BeforeQuery = `query {
  recentPosts(count:2, before: "2014-09-08T00:00:00.000Z") {
    _id,
    cursor,
    title
  }
...
export const back2BeforeResponse = {
  "data": {
    "recentPosts": [
      {
        "_id": "0176413761b289e6d64c2c14a758c1c7",
...
export const back2BeforeNormalized = {
  "entities": {
    "Post": {
      "0176413761b289e6d64c2c14a758c1c7": {
        "_id": "0176413761b289e6d64c2c14a758c1c7",
...
export const back5QueryAfter5 = `
query {
  recentPosts(count:5, before: "2015-07-07T00:00:00.000Z") {
    _id,
    cursor,
    title
  }
...
export const back5ResponseAfter5 = {
  "data": {
    "recentPosts": [
      {
